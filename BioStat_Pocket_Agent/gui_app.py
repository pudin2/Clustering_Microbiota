...
HELP_TEXTS = {
    ...
    "assistant_provider": "Cloud usa un endpoint Qwen compatible con OpenAI; Local usa Ollama; Reglas no llama ningún modelo.",
    "assistant_model": "Modelo configurado en el proveedor. Cloud recomendado: qwen3.5-9b; local: qwen3.5:9b.",
...
class MicrobiotaGUI(tk.Tk):
    ...
    def ask_assistant(self):
        ...
        provider = self.inputs.get("assistant", {}).get("assistant_provider", tk.StringVar(value="cloud")).get().strip() or "cloud"
        default_model = "qwen3.5:9b" if provider == "local" else "qwen3.5-9b"
